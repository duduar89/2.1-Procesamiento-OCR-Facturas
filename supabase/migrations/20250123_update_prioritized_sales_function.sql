-- =================================================================
-- FUNCIÓN SQL MEJORADA: get_prioritized_sales_data_v2
-- Descripción:
-- Versión escalable e inteligente que automáticamente:
-- 1. Prioriza TPV oficial (numier) sobre importaciones manuales
-- 2. Excluye automáticamente devoluciones (referencia que empiece con "FR")
-- 3. Incluye ventas nocturnas del día siguiente (hasta 06:00h)
-- 4. Funciona para cualquier restaurante automáticamente
-- =================================================================
...
-- Comentarios de la lógica implementada:
-- 1. ✅ Prioriza automáticamente TPV oficial sobre importaciones
-- 2. ✅ INCLUYE devoluciones (FR) - son parte de la contabilidad real
-- 3. ✅ Incluye ventas nocturnas hasta 06:00h del día siguiente
-- 4. ✅ Excluye importaciones manuales con €0 si hay datos TPV
-- 5. ✅ Escalable para cualquier número de restaurantes
-- 6. ✅ No requiere hardcodear IDs específicos
